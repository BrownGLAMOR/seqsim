...
public class ThreeRoundWeber {
	public static void main(String[] args) throws IOException {
		...
		double p_precision = 0.05;	// price precision
		...
		int preference = -1;							// MDP agent preference: 2 = favor mixing, -1 = favor lower bound
...
//					}
		...
		if (print_strategy == true){
			FileWriter fw_strat = new FileWriter("/Users/jl52/Desktop/Amy_paper/workspace/paper/threerounds/weber_weberstart_" + no_agents + "_" + v_precision + "_" + p_precision + "_" + no_iterations + ".csv");
