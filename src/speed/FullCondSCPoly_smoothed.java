...
public class FullCondSCPoly_smoothed {
...
//				FullCondMDPAgent4 mdp_agent = new FullCondMDPAgent4(value, 1, preference, epsilon, discretize_value, v_precision);
			...
			for (int it = 0; it < no_iterations; it++) {
				...
				FullCondMDPsmoothedAgent[] mdp_agents = new FullCondMDPsmoothedAgent[no_agents]; 
...
//					mdp_agents[i] = new FullCondMDPAgent4(new MenezesValue(max_value, rng, decreasing), i, preference, epsilon, discretize_value, v_precision);
					mdp_agents[i] = new FullCondMDPsmoothedAgent(value, 1, gamma, false, 0.01);
			...
			if (print_strategy == true){
				FileWriter fw_strat = new FileWriter("/Users/jl52/Desktop/Amy_paper/workspace/paper/june1st/smoothed/Menepoly" + order + "_" + no_agents + "_" + precision + "_" + no_iterations + ".csv");
